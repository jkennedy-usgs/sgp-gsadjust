...
return out;},decode:function(inp,outType,safe,lax){if(arguments.length<1)return null;if(arguments.length<2)outType=0;if(outType!=0&&outType!=1&&outType!=2)return null;if(arguments.length>=3&&safe!=true&&safe!=false)return null;var sEnc=(arguments.length>=3&&safe)?this.encStringS:this.encString;if(arguments.length>=4&&lax!=true&&lax!=false)return null;var aDec={};for(var p=0;p<sEnc.length;p++){aDec[sEnc.charAt(p)]=p;}
var out=(outType==0)?[]:'';lax=(arguments.length==4&&lax);var l=0;var i=0;var j=0;var c=0;var k=0;var end=inp.length;var C='';if(lax){var inpS='';var ignore=false;var cnt=0;for(var p=1;p<=inp.length;p++){c=inp.charAt(end-p);if(c=='='){if(!ignore){if(++cnt>1)ignore=true;}else{}}else if(undefined!=aDec[c]){if(!ignore)ignore=true;inpS=c+inpS;}}
...
{var retVal=[];for(var i=0;i<str.length;++i)
...
{var result=[];while(bits.length%cnt)
...
{var result=[];for(var i=0;i<bytes.length;i++){for(var j=0;j<cnt;++j){result.push((bytes[i]&(1<<j))>>>j);}}
...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["GSadjust","1. Overview","2. Quick-start tutorial","3. Data tab","4. Drift tab","5. Network adjustment tab","6. Other tools","7. Considerations","Installing GSadjust","Data Organization","Data Tree View","Workflow","Simple example","Complete example","Data sets included with GSadjust","Loading data","Appending data","Selecting data","Plot toolbar"," Plotting options","Tares and the tare table","Drift correction","Delta-g observations","Datum observations","Network adjustment","Evaluating the adjustment","Outliers and standard deviation","Exporting results","Network visualization","Metadata export","Vertical gradient calculation","Tide correction","Show/edit station coordinates","Calculating gravity change over time","Logging","Loop animation","Show calibration coefficients","Dynamic data links between tabs and status indicators","Numpy vs Gravnet inversion","Vertical gradients","Saving and loading the workspace","Multiple meters","Samples","Occupations","Loops","Surveys","Campaign","Tree view context menu","Tree view toolbar","Survey and Loop metadata","Data Formats","Creating loops","Duplicate stations","No drift correction","Network-adjustment drift correction","Roman method drift correction","Continuous-model correction","Adding manually","Importing from text file","Importing from g files","Network adjustment options dialog","Plotting gravity time-series","Map-view gravity change"],
    DREX_NODE_LINKS: ["index.htm","overview.htm","quick_start_tutorial.htm","data_tab.htm","drift_tab.htm","network_adjustment_tab.htm","other_tools.htm","considerations.htm","installing_gsadjust.htm","data_organization.htm","data_tree_view.htm","workflow.htm","simple_example.htm","complete_example.htm","data_sets_included_with_gsadjust.htm","loading_data.htm","appending_data.htm","selecting_data.htm","plot_toolbar.htm","_plotting_options.htm","tares_and_the_tare_table.htm","drift_correction.htm","delta_g_observations.htm","datum_observations.htm","network_adjustment.htm","evaluating_the_adjustment.htm","outliers_and_standard_deviation.htm","exporting_results.htm","network_visualization.htm","metadata_export.htm","vertical_gradient_calculation.htm","tide_correction.htm","show_edit_station_coordinates.htm","calculating_gravity_change_over_time.htm","logging.htm","loop_animation.htm","show_calibration_coefficients.htm","dynamic_data_links_between_tabs_and_status_indicators.htm","numpy_vs_gravnet_inversion.htm","vertical_gradients.htm","saving_and_loading_the_workspace.htm","multiple_meters.htm","samples.htm","occupations.htm","loops.htm","surveys.htm","campaign.htm","tree_view_context_menu.htm","tree_view_toolbar.htm","survey_and_loop_metadata.htm","data_formats.htm","creating_loops.htm","duplicate_stations.htm","no_drift_correction.htm","network_adjustment_drift_correction.htm","roman_method_drift_correction.htm","continuous_model_correction.htm","adding_manually.htm","importing_from_text_file.htm","importing_from_g_files.htm","network_adjustment_options_dialog.htm","plotting_gravity_time_series.htm","map_view_gravity_change.htm"],
    DREX_NODE_CHILD_START: [1,8,12,15,19,22,28,37,42,42,47,50,50,50,50,50,53,53,53,53,53,53,57,57,60,61,61,61,61,61,61,61,61,61,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],
    DREX_NODE_CHILD_END: [8,12,15,19,22,28,37,42,42,47,50,50,50,50,50,53,53,53,53,53,53,57,57,60,61,61,61,61,61,61,61,61,61,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],
    DREX_MENU_TYPE: 1,
