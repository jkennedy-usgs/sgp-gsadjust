...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["GSadjust","1. Overview","2. Quick-start tutorial","3. Data tab","4. Drift tab","5. Network adjustment tab","6. Other tools","7. Considerations","Installing GSadjust","Data Organization","Data Tree View","Workflow","Simple example","Complete example","Data sets included with GSadjust","Plot toolbar","Loading data","Appending data","Selecting data","Editing data","Creating loops"," Plotting options","Tares and the tare table","No drift correction","Network-adjustment drift correction","Roman method drift correction","Continuous-model correction","Delta-g observations","Datum observations","Network adjustment","Evaluating the adjustment","Outliers and standard deviation","Exporting results","Network visualization","Metadata export","Vertical gradient calculation","Tide correction","Dynamic data links between tabs and status indicators","Numpy vs Gravnet inversion","Vertical gradients","Saving and loading the workspace","Keyboard navigation","Multiple meters","Calculating gravity change over time","Samples","Occupations","Loops","Surveys","Campaign","Tree view context menu","Tree view toolbar","Specify start/end dates window","Start/end date file","Data Formats","Splitting data into loops","Adding manually","Importing from text file","Importing from g files","Network adjustment options dialog"],
    DREX_NODE_LINKS: ["index.htm","overview.htm","quick_start_tutorial.htm","data_tab.htm","drift_tab.htm","network_adjustment_tab.htm","other_tools.htm","considerations.htm","installing_gsadjust.htm","data_organization.htm","data_tree_view.htm","workflow.htm","simple_example.htm","complete_example.htm","data_sets_included_with_gsadjust.htm","plot_toolbar.htm","loading_data.htm","appending_data.htm","selecting_data.htm","editing_data.htm","creating_loops.htm","_plotting_options.htm","tares_and_the_tare_table.htm","no_drift_correction.htm","network_adjustment_drift_correction.htm","roman_method_drift_correction.htm","continuous_model_correction.htm","delta_g_observations.htm","datum_observations.htm","network_adjustment.htm","evaluating_the_adjustment.htm","outliers_and_standard_deviation.htm","exporting_results.htm","network_visualization.htm","metadata_export.htm","vertical_gradient_calculation.htm","tide_correction.htm","dynamic_data_links_between_tabs_and_status_indicators.htm","numpy_vs_gravnet_inversion.htm","vertical_gradients.htm","saving_and_loading_the_workspace.htm","keyboard_navigation.htm","multiple_meters.htm","calculating_gravity_change_over_time.htm","samples.htm","occupations.htm","loops.htm","surveys.htm","campaign.htm","tree_view_context_menu.htm","tree_view_toolbar.htm","specify_start_end_dates_window.htm","start_end_date_file.htm","data_formats.htm","splitting_data_into_loops.htm","adding_manually.htm","importing_from_text_file.htm","importing_from_g_files.htm","network_adjustment_options_dialog.htm"],
    DREX_NODE_CHILD_START: [1,8,12,15,21,27,33,37,44,44,49,51,51,51,51,51,51,55,55,55,55,55,55,55,55,55,55,55,55,58,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59],
    DREX_NODE_CHILD_END: [8,12,15,21,27,33,37,44,44,49,51,51,51,51,51,51,55,55,55,55,55,55,55,55,55,55,55,55,58,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59],
    DREX_MENU_TYPE: 1,
